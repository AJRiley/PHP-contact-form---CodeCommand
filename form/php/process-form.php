...
$email_address = 'ajriley774@gmail.com';
$company_address = 'Liverpool';
...
if (!empty($fields))
{
    ...
    if (empty($error_list))
    {
        ...
        if (mail($email_address, $subject, $content, "From: " . $fields['email'] . "\r\nReply-To: " . $fields['email'] . "\r\nReturn-Path: " . $fields['email'] . "\r\n"))
        {
            ...
            echo "<h2 class='success'>Submission Successful</h2>";
            echo "<br/><p class='success'>Thank you for contacting us, <strong>" . $fields['name'] . "</strong>. Someone will be in touch shortly.</p>";
        }
        else
        {
